...
const commonIngredients = [
  // Proteins
  { name: "Chicken Breast (Raw)", calories: 110, protein: 23, carbs: 0, fats: 1, servingSize: 100 },
  { name: "Chicken Thigh (Raw)", calories: 170, protein: 20, carbs: 0, fats: 10, servingSize: 100 },
  { name: "Ground Beef (90% Lean)", calories: 176, protein: 20, carbs: 0, fats: 10, servingSize: 100 },
  { name: "Salmon (Raw)", calories: 208, protein: 20, carbs: 0, fats: 13, servingSize: 100 },
  { name: "Egg (Large)", calories: 143, protein: 12.6, carbs: 0.7, fats: 9.5, servingSize: 100 }, // ~2 eggs
  { name: "Egg Whites", calories: 52, protein: 11, carbs: 0.7, fats: 0.2, servingSize: 100 },
  { name: "Tuna (Canned in Water)", calories: 116, protein: 26, carbs: 0, fats: 1, servingSize: 100 },
  { name: "Greek Yogurt (Non-fat)", calories: 59, protein: 10, carbs: 3.6, fats: 0.4, servingSize: 100 },
  { name: "Cottage Cheese (Low fat)", calories: 82, protein: 11, carbs: 3.4, fats: 2.3, servingSize: 100 },
  { name: "Tofu (Firm)", calories: 144, protein: 17, carbs: 3, fats: 9, servingSize: 100 },
  { name: "Whey Protein Powder", calories: 370, protein: 75, carbs: 5, fats: 5, servingSize: 100 }, // Generic

  // Carbs
  { name: "White Rice (Raw)", calories: 365, protein: 7, carbs: 80, fats: 0.7, servingSize: 100 },
  { name: "Brown Rice (Raw)", calories: 367, protein: 7.5, carbs: 76, fats: 3.2, servingSize: 100 },
  { name: "Oats (Rolled)", calories: 379, protein: 13, carbs: 67, fats: 6.5, servingSize: 100 },
  { name: "Sweet Potato (Raw)", calories: 86, protein: 1.6, carbs: 20, fats: 0.1, servingSize: 100 },
  { name: "Potato (Raw)", calories: 77, protein: 2, carbs: 17, fats: 0.1, servingSize: 100 },
  { name: "Pasta (Dry)", calories: 371, protein: 13, carbs: 75, fats: 1.5, servingSize: 100 },
  { name: "Quinoa (Raw)", calories: 368, protein: 14, carbs: 64, fats: 6, servingSize: 100 },
  { name: "Banana", calories: 89, protein: 1.1, carbs: 23, fats: 0.3, servingSize: 100 },
  { name: "Apple", calories: 52, protein: 0.3, carbs: 14, fats: 0.2, servingSize: 100 },
  { name: "Blueberries", calories: 57, protein: 0.7, carbs: 14, fats: 0.3, servingSize: 100 },
  { name: "Bread (Whole Wheat)", calories: 247, protein: 13, carbs: 41, fats: 3.4, servingSize: 100 },

  // Fats
  { name: "Almonds", calories: 579, protein: 21, carbs: 22, fats: 50, servingSize: 100 },
  { name: "Peanut Butter", calories: 588, protein: 25, carbs: 20, fats: 50, servingSize: 100 },
  { name: "Avocado", calories: 160, protein: 2, carbs: 9, fats: 15, servingSize: 100 },
  { name: "Olive Oil", calories: 884, protein: 0, carbs: 0, fats: 100, servingSize: 100 },
  { name: "Butter", calories: 717, protein: 0.9, carbs: 0.1, fats: 81, servingSize: 100 },
  { name: "Walnuts", calories: 654, protein: 15, carbs: 14, fats: 65, servingSize: 100 },
  { name: "Chia Seeds", calories: 486, protein: 17, carbs: 42, fats: 31, servingSize: 100 },

  // Vegetables
  { name: "Broccoli", calories: 34, protein: 2.8, carbs: 7, fats: 0.4, servingSize: 100 },
  { name: "Spinach", calories: 23, protein: 2.9, carbs: 3.6, fats: 0.4, servingSize: 100 },
  { name: "Carrots", calories: 41, protein: 0.9, carbs: 10, fats: 0.2, servingSize: 100 },
  { name: "Bell Pepper", calories: 20, protein: 0.9, carbs: 4.6, fats: 0.2, servingSize: 100 },
  { name: "Cucumber", calories: 15, protein: 0.7, carbs: 3.6, fats: 0.1, servingSize: 100 },
  { name: "Tomato", calories: 18, protein: 0.9, carbs: 3.9, fats: 0.2, servingSize: 100 },
  { name: "Onion", calories: 40, protein: 1.1, carbs: 9, fats: 0.1, servingSize: 100 },
  { name: "Mushrooms", calories: 22, protein: 3.1, carbs: 3.3, fats: 0.3, servingSize: 100 },
  { name: "Asparagus", calories: 20, protein: 2.2, carbs: 3.9, fats: 0.1, servingSize: 100 },
