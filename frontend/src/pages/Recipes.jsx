                        ...
                        {recipes.map((recipe) => (
                            <div key={recipe._id} className="bg-white shadow-sm rounded-xl overflow-hidden border border-slate-200 flex flex-col transition-all duration-200 hover:shadow-md">
                                ...
                                <div className="p-6 flex-1">
                                    <div className="flex justify-between text-sm text-slate-500 mb-4 bg-slate-50 p-2 rounded-lg">
                                        <span className="font-medium text-slate-700">{Math.round(recipe.totalMacros.calories)} kcal</span>
                                    ...
                                    <ul className="space-y-2 mb-6">
                                        {recipe.ingredients.slice(0, 3).map((item, idx) => (
                                            <li key={idx} className="flex justify-between text-sm">
                                                ...
                                                <span className="text-slate-500 bg-slate-100 px-2 py-0.5 rounded text-xs">{item.amount}g</span>
                                            </li>
                                        ))}
                                ...
                                <div className="bg-slate-50/50 px-6 py-4 border-t border-slate-100">
                                    <button
                                        ...
                                        disabled={consuming}
                                        className="w-full flex justify-center items-center px-4 py-2.5 border border-transparent text-sm font-medium rounded-xl text-emerald-700 bg-emerald-50 hover:bg-emerald-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all duration-200"
                                    >
